 ...
 */
final class Version20260209093805 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ACTIVIDADES (CODACTIVIDAD SMALLINT IDENTITY NOT NULL, NOMBRE NVARCHAR(40) NOT NULL, ESTADO NVARCHAR(255) NOT NULL, ESTADO_APROBACION NVARCHAR(20) NOT NULL, ESTADO_NEW NVARCHAR(255), DIRECCION NVARCHAR(40) NOT NULL, SECTOR NVARCHAR(50), DESCRIPCION VARCHAR(MAX), FECHA_INICIO DATETIME2(6) NOT NULL, FECHA_FIN DATETIME2(6) NOT NULL, MAX_PARTICIPANTES SMALLINT NOT NULL, CIF_EMPRESA NCHAR(9), PRIMARY KEY (CODACTIVIDAD))');
        ...
        $this->addSql('CREATE TABLE ORGANIZACIONES (CIF NCHAR(9) NOT NULL, NOMBRE NVARCHAR(40) NOT NULL, EMAIL VARCHAR(100) NOT NULL UNIQUE, SECTOR NVARCHAR(100), DIRECCION NVARCHAR(40) NOT NULL, LOCALIDAD NVARCHAR(40) NOT NULL, CP CHAR(5) NOT NULL, DESCRIPCION NVARCHAR(200) NOT NULL, CONTACTO NVARCHAR(40) NOT NULL, ESTADO NVARCHAR(20) NOT NULL, FCM_TOKEN NVARCHAR(255), PRIMARY KEY (CIF))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_3295227310C6BEC4 ON ORGANIZACIONES (EMAIL) WHERE EMAIL IS NOT NULL');
        $this->addSql('CREATE TABLE VOLUNTARIOS (DNI NCHAR(9) NOT NULL, NOMBRE NVARCHAR(100) NOT NULL, APELLIDO1 NVARCHAR(100) NOT NULL, APELLIDO2 NVARCHAR(100) NOT NULL, CORREO NVARCHAR(40) NOT NULL, ZONA NVARCHAR(100), FECHA_NACIMIENTO DATETIME2(6) NOT NULL, EXPERIENCIA NVARCHAR(200), COCHE BIT NOT NULL, DISPONIBILIDAD VARCHAR(MAX), IDIOMAS VARCHAR(MAX), ESTADO_VOLUNTARIO NVARCHAR(20) NOT NULL, FCM_TOKEN NVARCHAR(255), CURSO_CICLOS SMALLINT, NOMBRE_CICLOS NVARCHAR(100), PRIMARY KEY (DNI))');
        ...
        $this->addSql('CREATE TABLE administrador (id INT IDENTITY NOT NULL, email NVARCHAR(180) NOT NULL, roles VARCHAR(MAX) NOT NULL, nombre NVARCHAR(255) NOT NULL, PRIMARY KEY (id))');

        ...
        try {
            ...
            foreach ($inscripciones as $inscripcion) {
                ...
                $data[] = [
                    ...
                    'habilidades_voluntario' => $voluntario->getHabilidades()->map(fn($h) => ['id' => $h->getId(), 'nombre' => $h->getNombre()])->toArray(),
                    'disponibilidad_voluntario' => $voluntario->getDisponibilidad(),
                    'intereses_voluntario' => $voluntario->getIntereses()->map(fn($i) => ['id' => $i->getId(), 'nombre' => $i->getNombre()])->toArray(),
                    ...
                    'habilidades_actividad' => $actividad->getHabilidades()->map(fn($h) => ['id' => $h->getId(), 'nombre' => $h->getNombre()])->toArray(),

...
export class CategoryService {
    ...
    getODS(forceReload = false): Observable<ODS[]> {
        ...
        return this.http.get<ODS[]>(`${this.apiUrl}/ods`).pipe(
    ...
    getHabilidades(forceReload = false): Observable<Category[]> {
        ...
        return this.http.get<Category[]>(`${this.apiUrl}/habilidades`).pipe(
    ...
    getIntereses(forceReload = false): Observable<Category[]> {
        ...
        return this.http.get<Category[]>(`${this.apiUrl}/intereses`).pipe(
    ...
    getNecesidades(forceReload = false): Observable<Category[]> {
        ...
        return this.http.get<Category[]>(`${this.apiUrl}/necesidades`).pipe(

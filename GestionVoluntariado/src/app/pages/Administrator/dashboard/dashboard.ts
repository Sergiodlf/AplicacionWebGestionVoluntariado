  ...
  loadVolunteers() {
    ...
    this.volunteerService.getVolunteers().subscribe({
      next: (data) => {
        ...
        console.log('Volunteers metrics updated:', { total: this.volunteersTotal, pending: this.volunteersPending });
      },
  ...
  loadOrganizations() {
    ...
    this.organizationService.getOrganizations().subscribe({
      next: (data) => {
        ...
        console.log('Organizations metrics updated:', { total: this.organizationsTotal, pending: this.organizationsPending });
      },
